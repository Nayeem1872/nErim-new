...
import { Breadcrumb, Button, Card, Col, FloatButton, message, Result, Row } from "antd";
...
const Dashboard = ({ isDarkMode, handleClick }) => {
  ...
  const isError = apiData &&
    (!apiData.matrixStatus || !apiData.likelihoodStatus || !apiData.impactStatus);
